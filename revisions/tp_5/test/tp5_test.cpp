...
TEST_CASE ( "TP5_Histogramme::Generique" ) {
 using histo_t = HistogrammeTemplate<>;
...
TEST_CASE ( "TP5_Histogramme::FoncteurGreater" ) {
 using histo_t = HistogrammeTemplate<std::greater<Classe>>;
...
TEST_CASE ( "TP5_Histogramme::ComparateurQuantite" ) {
 using histo_t = HistogrammeTemplate<ComparateurQuantite<Classe>>;
...
TEST_CASE ( "TP5_Histogramme::Conversion" ) {
 using histo1_t = HistogrammeTemplate<std::greater<Classe>>;
 using histo2_t = HistogrammeTemplate<ComparateurQuantite<Classe>>;
